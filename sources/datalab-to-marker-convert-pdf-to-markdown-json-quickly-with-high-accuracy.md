...
[![](https://github.com/datalab-to/marker/raw/master/data/images/overall.png)](https://github.com/datalab-to/marker/blob/master/data/images/overall.png)
...
[![](https://github.com/datalab-to/marker/raw/master/data/images/table.png)](https://github.com/datalab-to/marker/blob/master/data/images/table.png)
...
[![](https://github.com/datalab-to/marker/raw/master/data/images/per_doc.png)](https://github.com/datalab-to/marker/blob/master/data/images/per_doc.png)
...
- [Deployment example with Modal](https://github.com/datalab-to/marker/blob/master/examples/README_MODAL.md) that shows you how to deploy and access `marker` through a web endpoint using [`Modal`](https://modal.com/). Modal is an AI compute platform that enables developers to deploy and scale models on GPUs in minutes.
