...
[voicebox.sh](https://voicebox.sh/) • [Docs](https://docs.voicebox.sh/) • [Download](#download) • [Features](#features) • [API](#api) • [Troubleshooting](https://github.com/jamiepine/voicebox/blob/main/docs/content/docs/overview/troubleshooting.mdx)

[![Voicebox App Screenshot](https://github.com/jamiepine/voicebox/raw/main/landing/public/assets/app-screenshot-1.webp)](https://voicebox.sh/)

*Click the image above to watch the demo video on [voicebox.sh](https://voicebox.sh/)*

[![Voicebox Screenshot 2](https://github.com/jamiepine/voicebox/raw/main/landing/public/assets/app-screenshot-2.webp)](https://github.com/jamiepine/voicebox/blob/main/landing/public/assets/app-screenshot-2.webp)

[![Voicebox Screenshot 3](https://github.com/jamiepine/voicebox/raw/main/landing/public/assets/app-screenshot-3.webp)](https://github.com/jamiepine/voicebox/blob/main/landing/public/assets/app-screenshot-3.webp)
...
> **Having trouble?** See the [Troubleshooting Guide](https://github.com/jamiepine/voicebox/blob/main/docs/content/docs/overview/troubleshooting.mdx) for common install, generation, model-download, and GPU issues.
...
| Linux (AMD) | PyTorch (ROCm) | Auto-configures HSA\_OVERRIDE\_GFX\_VERSION |
...
For the **full engineering status, open-issue triage, and prioritized work queue**, see [`docs/PROJECT_STATUS.md`](https://github.com/jamiepine/voicebox/blob/main/docs/PROJECT_STATUS.md) — a living document that tracks what's shipped, what's in-flight, candidate TTS engines under evaluation, and why we've accepted or backlogged specific integrations.

---

## Development

See [CONTRIBUTING.md](https://github.com/jamiepine/voicebox/blob/main/CONTRIBUTING.md) for detailed setup and contribution guidelines.
...
The multi-engine architecture makes adding new TTS engines straightforward. A [step-by-step guide](https://github.com/jamiepine/voicebox/blob/main/docs/content/docs/developer/tts-engines.mdx) covers the full process: dependency research, backend protocol implementation, frontend wiring, and PyInstaller bundling.

The guide is optimized for AI coding agents. An [agent skill](https://github.com/jamiepine/voicebox/blob/main/.agents/skills/add-tts-engine/SKILL.md) can pick up a model name and handle the entire integration autonomously — you just test the build locally.
...
Contributions welcome! See [CONTRIBUTING.md](https://github.com/jamiepine/voicebox/blob/main/CONTRIBUTING.md) for guidelines.

## Security

Found a security vulnerability? Please report it responsibly. See [SECURITY.md](https://github.com/jamiepine/voicebox/blob/main/SECURITY.md) for details.

---

## License

MIT License — see [LICENSE](https://github.com/jamiepine/voicebox/blob/main/LICENSE) for details.

---

[voicebox.sh](https://voicebox.sh/)