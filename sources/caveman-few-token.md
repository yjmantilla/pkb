...
**🪨 Caveman Ecosystem** · **caveman** *talk less* <sub>(you are here)</sub> · [cavemem](https://github.com/JuliusBrussee/cavemem) *remember more* · [cavekit](https://github.com/JuliusBrussee/cavekit) *build better*
...
- **Custom statusline:** Installer leaves your existing statusline alone. See [`hooks/README.md`](https://github.com/JuliusBrussee/caveman/blob/main/hooks/README.md) for the merge snippet
**Codex — full details**
...
Code blocks, URLs, file paths, commands, headings, dates, version numbers — anything technical passes through untouched. Only prose gets compressed. See the full [caveman-compress README](https://github.com/JuliusBrussee/caveman/blob/main/caveman-compress/README.md) for details. [Security note](https://github.com/JuliusBrussee/caveman/blob/main/caveman-compress/SECURITY.md): Snyk flags this as High Risk due to subprocess/file patterns — it's a false positive.

## Benchmarks

Real token counts from the Claude API ([reproduce it yourself](https://github.com/JuliusBrussee/caveman/blob/main/benchmarks)):
