...
- Now you can use your `upstream` *remote* to make sure your fork's `master` is up to date.
...
2. go back to your branch and rebase it: `git checkout my_feature` and then `git rebase my_feature`
